...
The axes in the current level editor are **not accurate** to the game's coordinate system.
As a result, the level editor should not be used as a reference for coordinate-related work.
